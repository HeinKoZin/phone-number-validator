...
const MPT = [
  ...
  { prefix: "0923", length: 9 },
  { prefix: "0924", length: 9 },
  { prefix: "0925", length: 11 },
  { prefix: "0926", length: 11 },
  { prefix: "0940", length: 11 },
  { prefix: "0941", length: 10 },
  { prefix: "0942", length: 11 },
  { prefix: "0943", length: 10 },
  { prefix: "0944", length: 11 },
...
function validatePhoneNumber(phoneNumber: string) {
  ...
  const prefix = [...MPT, ...ATOM, ...OOREDOO, ...MEC, ...MYTEL].find(
    (item: any) => phoneNumber.startsWith(item.prefix),
  );
  if (!prefix || phoneNumber.length !== prefix.length)
    return { valid: false, operator: null };
